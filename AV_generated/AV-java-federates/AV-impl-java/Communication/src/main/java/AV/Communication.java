...
/**
 * The Communication type of federate for the federation designed in WebGME.
 *
 */
public class Communication extends CommunicationBase {
    private final static Logger log = LogManager.getLogger();

    private double currentTime = 0;

    public Communication(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            Communication federate = new Communication(federateConfig);
            federate.execute();
            log.info("Done.");
            System.exit(0);
        } catch (Exception e) {
